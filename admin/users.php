        ...
        <main class="admin-main">
            ...
            <form method="GET" class="filter-bar">
                ...
                <?php if ($search || $filterRole || $filterBlood): ?>
                    <a href="users.php" class="clear-filters">✕ Clear</a>
                <?php endif; ?>
            </form>
                    ...
                    <table class="admin-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $user['is_donor'] ? 'Yes' : 'No'; ?></td>
                                <td><?php echo date('M d', strtotime($user['created_at'])); ?></td>
                                <td class="actions-cell">
                                    <a href="?edit=<?php echo $user['id']; ?>" class="btn-edit" title="Edit">Edit</a>
                                    <?php if ($user['id'] !== $_SESSION['user_id']): ?>
                                        <a href="?delete=<?php echo $user['id']; ?>" class="btn-delete" title="Delete" onclick="return confirm('Delete this user?')">Delete</a>
                                    <?php endif; ?>
                                </td>
                            </tr>
                            <?php endforeach; ?>
    ...
    <div id="addUserModal" class="modal-overlay" style="display:none;">
        <div class="modal-content">
            <div class="modal-header">
                <h2>Add New User</h2>
                <button class="modal-close" onclick="toggleModal('addUserModal')">✕</button>
            </div>
