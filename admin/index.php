...
// Recent users (FIXED: removed role & is_donor)
$recentUsers = $pdo->query("
    SELECT id, first_name, last_name, email, blood_group, location, created_at 
    FROM users 
            ...
            <div class="charts-row">
                <div class="chart-card">
                    ...
                    <div class="chart-legend">
                        <span class="legend-item"><span class="legend-dot donors"></span> Donors:
                            <?php echo $totalDonors; ?></span>
                        <span class="legend-item"><span class="legend-dot receivers"></span> Receivers:
                            <?php echo $totalReceivers; ?></span>
                    </div>
                </div>
